...
def send_event_to_flask(event_data: dict) -> bool:
    try:
        response = requests.post('http://localhost:8091/internal/event', json=event_data)
...
def get_latest_events(
    ...
    for peer in peers:
        tracker_folder_images = datasites_path / peer / "api_data" / API_NAME / "images"
        tracker_folder_events = datasites_path / peer / "api_data" / API_NAME / "events"
